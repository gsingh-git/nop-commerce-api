...
namespace Nop.Plugin.Api.Controllers
{
    public class ProductsController : BaseApiController
    {
        ...
        /// <param name="parameters">Parameters of product search</param>
        /// <response code="200">OK</response>
        /// <response code="404">Not Found</response>
        /// <response code="401">Unauthorized</response>
        [HttpGet]
        ...
        [ProducesResponseType(typeof(string), (int)HttpStatusCode.NotFound)]
        [GetRequestsErrorInterceptorActionFilter]
        public IActionResult GetProductByCategoryId(int id, ProductsParametersModel parameters)
        {
            if (id <= 0)
            {
                return Error(HttpStatusCode.BadRequest, "id", "invalid category id");
            }
            ...
            var allProducts = _productApiService.GetProducts(categoryId: id)
                .Where(p => StoreMappingService.Authorize(p));
